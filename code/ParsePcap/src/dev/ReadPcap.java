...
//					frameno,time,IAT,size,rate);
			String strFrame = frameno + "," + time + "," + IAT + "," + size + "," + rate + "\n";
	...
	public static void outputToFile(String filename,double IAT,int size,double rate){
		File frameInfoFile = new File(filename);
...
//						outputToFile(outputFilename, frameNumber, time, IAT, frameSize,transRate);
						outputToFile(outputFilename, IAT, frameSize,transRate);
					}
...
//					break;
	...
	public static void main(String[] args){
		//device = ["wz_iphone5","lib_DELL","lpf_phone2","cyf_dell","huawei","xiaomi3_phone"]
		final String DATA_PATH = "G:/graduate_git/data_set/";
		final String DEVICE_NAME = "xiaomi3_phone";
		final String FILE_NAME = DATA_PATH + DEVICE_NAME + ".pcap";	
		final String OUTPUT_FILE_NAME = "G:/graduate_git/Data/" + DEVICE_NAME + ".txt";
